...
export default async function ConvivenciaRadarPage() {
    ...
    if (!profile?.institution_id || profile.role !== "convivencia") return redirect("/convivencia")
        ...
        <main className="min-h-screen bg-slate-50">
            <div className="mx-auto max-w-3xl px-4 py-8 space-y-6">
                ...
                <section className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
                    ...
                    <RadarManagerClient courses={coursesWithSessions} institutionId={iid} role="convivencia" />
                </section>
            </div>
        </main>
    )
