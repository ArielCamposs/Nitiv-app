...
export default async function ResourcesPage() {
    ...
    // Fetch resources (shared with teachers)
    ...
    return (
        <div className="min-h-screen bg-[#FDFBF7] md:pl-64 pb-24 md:pb-6">
            ...
            <header className="p-6 bg-gradient-to-br from-white to-[#F8F9FA] shadow-sm mb-6 border-b-2 border-gray-200">
                ...
                <p className="text-[#64748B]">Protocolos, guías, consejos y herramientas compartidas</p>
            </header>
            ...
            <main className="px-6 space-y-8">
                ...
                {(!resources || resources.length === 0) && (
                    <div className="bg-white rounded-2xl p-12 text-center">
                        ...
                        <p className="text-sm text-gray-400 mt-1">Los recursos compartidos aparecerán aquí cuando sean agregados</p>
                    </div>
                )}
            </main>
        </div>
