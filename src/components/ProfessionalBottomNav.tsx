...
import { Home, Users, FileText, Calendar, LogOut, AlertTriangle, TrendingUp, BookOpen } from 'lucide-react'
...
const NAV_ITEMS = [
    ...
    {
        href: '/dashboard/professional/dec',
        icon: AlertTriangle,
        label: 'DEC',
        color: 'from-orange-400 to-orange-600', // Added color for DEC item
        activeColor: 'text-orange-600' // Added activeColor for DEC item
    },
    {
        href: '/dashboard/professional/activities',
        icon: Calendar,
        label: 'Actividades',
    ...
    {
        href: '/dashboard/professional/statistics',
        icon: TrendingUp,
        label: 'Estadísticas',
    ...
    {
        href: '/dashboard/professional/reports',
        icon: FileText,
        label: 'Reportes',
    ...
    {
        href: '/dashboard/professional/resources',
        icon: BookOpen,
        label: 'Recursos',
                ...
                <div className="flex justify-around items-center h-20 px-2">
                    {NAV_ITEMS.map((item) => {
                        ...
                        const isActive = pathname === item.href ||
                            (item.href !== '/dashboard/professional' && pathname?.startsWith(item.href))
